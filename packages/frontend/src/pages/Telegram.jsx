...
import { MessageCircle, Link as LinkIcon, User, Power, Pause, Trash2, RefreshCw, Edit2, Check, X } from 'lucide-react';
    ...
    <div>
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Gestiona vinculaciones de usuarios con el bot</p>
        </div>
